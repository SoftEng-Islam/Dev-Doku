...
function setColorTheme(color: number): void {
	...
	case 2:
		...
		rootElement.style.setProperty("--LTheme2", 'var(--Lth_pur1)');
		rootElement.style.setProperty("--LTheme3", 'var(--Lth_pur1)');
		rootElement.style.setProperty("--LTheme4", 'var(--Lth_pur1)');
		break;
	case 3:
		...
		rootElement.style.setProperty("--LTheme2", 'var(--Lth_pin1)');
		rootElement.style.setProperty("--LTheme3", 'var(--Lth_pin1)');
		rootElement.style.setProperty("--LTheme4", 'var(--Lth_pin1)');
		break;
	case 4:
		...
		rootElement.style.setProperty("--LTheme2", 'var(--Lth_blu1)');
		rootElement.style.setProperty("--LTheme3", 'var(--Lth_blu1)');
		rootElement.style.setProperty("--LTheme4", 'var(--Lth_blu1)');
	...
	case 5:
		...
		// Light
		rootElement.style.setProperty("--LTheme1", 'var(--Lth_gre4)');
		rootElement.style.setProperty("--LTheme2", 'var(--Lth_gre4)');
		rootElement.style.setProperty("--LTheme3", 'var(--Lth_gre4)');
