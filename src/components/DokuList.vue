...
<template lang="pug">
//- All Docs List
div(class="absolute w-52 h-[var(--DokuListsHeight)] z-10 p-4 left-0 bg-[var(--cD3)]")
	div()
		input(type="text", placeholder="Search..." value="" , class="w-full h-8 px-2 rounded-md bg-[var(--cD1)] text-white" )
	div(class="")
